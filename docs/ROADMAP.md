...
- [x] Prompt Knowledge Base (PKB) catalog MVP — Docs-as-Code under `docs/prompts/` (#134); inventory via `aios_audit_docs` (#154); textual/tag search (#158); RAG/embeddings deferred — SSOT boundaries: [rag-boundaries](./guides/rag-boundaries.md) (#328)
