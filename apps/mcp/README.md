...
| `aios_compile_prompt`                                                                                               | Governed brief (#59); optional `skillIds` (ADR-0026 — `skill.denied` if tool ∉ pack `allowedTools`); optional `scope` (#305) |
...
| `aios_visibility`                                                                                                   | Visibility Plane snapshot (ADR-0030)                                                                                         |
| `aios_get_run_decisions`                                                                                            | Read-only DecisionRecord ledger for a persisted run (ADR-0034 / #502)                                                        |
