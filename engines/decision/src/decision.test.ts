...
describe('shouldRunAgent', () => {
  it('analyze.project agenda os quatro', () => {
    expect(agentsForIntent('analyze.project')).toEqual(['architecture', 'appsec', 'docs', 'qa']);
  ...
  it('implement.feature agenda os quatro', () => {
    expect(agentsForIntent('implement.feature')).toEqual(['architecture', 'appsec', 'docs', 'qa']);
  });
